...
#include <memory>
#include "../../untitled2/graphicsview.h"
...
QT_MOC_LITERAL(1, 13, 8), // "viewSize"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 16), // "singleTapTimeout"
QT_MOC_LITERAL(4, 40, 20), // "resetDoubleClickFlag"
QT_MOC_LITERAL(5, 61, 15), // "mousePressEvent"
QT_MOC_LITERAL(6, 77, 12), // "QMouseEvent*"
QT_MOC_LITERAL(7, 90, 5), // "event"
QT_MOC_LITERAL(8, 96, 14) // "mouseMoveEvent"

    },
    "GraphicsView\0viewSize\0\0singleTapTimeout\0"
    "resetDoubleClickFlag\0mousePressEvent\0"
...
void GraphicsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { QSize _r = _t->viewSize();
            if (_a[0]) *reinterpret_cast< QSize*>(_a[0]) = std::move(_r); }  break;
        case 1: _t->singleTapTimeout(); break;
        case 2: _t->resetDoubleClickFlag(); break;
